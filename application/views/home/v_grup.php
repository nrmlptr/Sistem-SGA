 ...
 <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"></span>
            <a href="<?php echo base_url('home/add_grup')?>"><button class='btn btn-secondary'>Tambah Data <i class='bx bx-add-to-queue'></i></button></a>
        </h4>

        <!-- Basic Bootstrap Table -->
        <div class="card">
            <h5 class="card-header">Data Group - PT Century Batteries Indonesia</h5>
