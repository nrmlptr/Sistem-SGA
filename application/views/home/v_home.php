                    ...
                    <?php 
                        ...
                        <tr>
                            ...
                            <td class="text-center"><?php if($data['status'] != 'Finish'):?>
                                <a href="<?php echo base_url('home/perbaruidataSGA/'.$data['id_pekerjaan']);?>" class="btn btn-success">EDIT</a><?php endif?>
                                <a href="<?php echo base_url('home/hapusDataByIdSGA/'.$data['id_pekerjaan']);?>" class="btn btn-danger btn-hapus" onclick="return confirm('Apakah Anda Yakin Akan Menghapus Data?')">DELETE</a>
                            </td>
