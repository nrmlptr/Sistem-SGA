            ...
            <div class="col-xxl">
                <div class="card mb-4">
                    <div class="card-header d-flex align-items-center justify-content-between">
                        <h5 class="mb-0">Tambah Data Seksi SGA</h5>
                    ...
                    <div class="card-body">
                        <form action="<?php echo base_url('home/proses_simpan_sie');?>" method="POST">
                            ...
                            <div class="row mb-3 mt-4">
                                <label class="col-sm-2 col-form-label" for="nm_dept">Nama Seksi</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="nm_sie" name="nm_sie" placeholder="Tulis Nama Seksi" />
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label class="col-sm-2 col-form-label" for="nm_kasie">Nama Kepala Seksi</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="nm_kasie" name="nm_kasie" placeholder="Tulis Nama Kasi" />
                                </div>
                            </div>
                            <div class="row mb-3">
